"""
Test script to generate a more complex OpenSCAD model.
This demonstrates the RAG system's ability to generate intricate models.
"""
...
MODEL_NAME = "complex_test_model.scad"
...
9. Use proper OpenSCAD syntax for boolean operations"""
...
def main():
    # Complex test prompt
    prompt = """Create a parametric phone stand with adjustable angle and rounded corners.
It should have:
1. A base that's 100mm wide and 80mm deep
2. An adjustable phone holder that can tilt from 45 to 75 degrees
3. The holder should be able to accommodate phones of different widths (60-90mm)
4. Add rounded corners with 5mm radius
5. Include built-in cable management"""
    
    print("Starting complex model generation...")
